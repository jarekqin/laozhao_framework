...
def get_1min_north_and_south_in_flow_data(save_type='csv',save_path=None):
    ...
    response = requests.get('https://push2.eastmoney.com/api/qt/kamt.rtmin/get?fields1=f1,f2,f3,f4&fields2=f51,f52,f53,f54,f55,f56&ut=b2884a393a59ad64002292a3e90d46a5&cb', headers=headers, cookies=cookies)
    ...
    n2s_df=pd.DataFrame(
        {'datetime': n2s_datetime, 'hk_sh_net_in_flow': n2s_sh_net_income, 'hk_sh_remained': n2s_sh_remianed_amt,
         'hk_sz_net_in_flow': n2s_sz_net_income, 'hk_sz_remained': n2s_sz_remained_amt,'southen_in_flow':southern_amount
         })
...
def get_1min_north_and_south_net_buy(save_type='csv',save_path=None):
    ...
    response = requests.get('https://push2.eastmoney.com/api/qt/kamtbs.rtmin/get?fields1=f1,f2,f3,f4&fields2=f51,f54,f52,f58,f53,f62,f56,f57,f60,f61&ut=b2884a393a59ad64002292a3e90d46a5&cb', headers=headers, cookies=cookies)
    temp=response.json()
